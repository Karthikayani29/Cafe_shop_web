...
const ServicesData = [
    {
        ...
        img : Img2,
        name : "Espresso",
        description : "The company itself is a very successful company...." ,
        aosDelay : "100" ,
    },
    {
        id : 2,
    ...
    <div className='py-10 bg-white'>
        <div className="container">
            ...
            <div className='text-center mb-20'>
                ...
                text-gray-800">Best Coffee for you</h1>
            </div>
            ...
            md:grid-cols-3 gap-14 md:gap-5 place-items-center'>
                {
                  ServicesData.map((data,index) => {
                    return(
                        ...
                        hover:bg-primary hover:text-white shadow-xl
                        duration-200 max-w-[300px] group relative'> 
                         ...
                         <div className='p-4 text-center'> 
                            <h1 className='text-xl text-gray-800 font-bold'>{data.name}
                            </h1>
